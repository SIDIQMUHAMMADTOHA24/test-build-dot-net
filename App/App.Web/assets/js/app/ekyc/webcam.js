...
function Webcam() {
    $('#label_full_name').html($('#full_name').val());
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.result) {
                        ...
                        $('#message_submit').html("Success submit data, please wait for the confirmation answer in your email");
                        Swal.fire({
                            text: data.message,
                            icon: "success",
                            buttonsStyling: false,
