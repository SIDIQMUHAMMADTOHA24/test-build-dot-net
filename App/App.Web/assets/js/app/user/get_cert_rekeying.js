$(document).ready(function () {
    ClickMenu('m_users');
    ClickMenu('m_list_rekeying_cert');
    Get();
    if (CheckCookie('_tm')) {
            ...
            if (msg.result) {
                ...
                for (var lu in list_certificate) {
                    ...
                    if (list_certificate[lu].status.includes('ISSUE')) {
                        action = `<div class="dropdown dropdown-inline"><button type="button" class="btn btn-light-primary btn-icon btn-sm" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="ki ki-bold-more-ver"></i></button><div class="dropdown-menu"><a class="dropdown-item" <a href="#" onclick="ModalRenewal('${list_certificate[lu].username}', '${list_certificate[lu].serial_number}')">Rekeying Certificate</a>`;
                    }
                    html += `<tr>
