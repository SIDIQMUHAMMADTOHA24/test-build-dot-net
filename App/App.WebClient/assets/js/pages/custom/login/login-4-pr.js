			...
			form,
			{
				fields: {
					...
					akta_pendirian: {
						validators: {
							notEmpty: {
								message: 'Akta Pendirian is required'
							},
							file: {
								extension: 'pdf',
								type: 'application/pdf',
								maxSize: 5242880,
								message: 'The selected file is not valid, just pdf with max size 5 Mb'
							}
						}
					},
					surat_permohonan: {
						validators: {
							notEmpty: {
								message: 'Surat Permohonan is required'
							},
							file: {
								extension: 'pdf',
								type: 'application/pdf',
					...
					surat_pengesahan: {
						validators: {
							notEmpty: {
								message: 'Surat Pengesahan is required'
							},
							file: {
								extension: 'pdf',
								type: 'application/pdf',
